...
/* 
			...
			$my_message  = 'Thank you for registering and paying ' . $payment_info['price'];
			$my_message .= ' for course : ' . '.';
			$my_message .= ' Your Verification or Confirmation ID is ' . $payment_info['code'] . "\n\n";
			$my_message .= 'Please proceed with our online talks.' . "\n";
			$my_message .= 'We look forward to seeing you in our talks.';
