			...
			'general' => array(
				...
				'options' => array(
					...
					'plugin-style' => array(
						...
						'options' => array(
							'container-width' => array(
								'title' => __('Container Width', 'gdlr-lms'),
								'type' => 'text',	
								'default' => '1140', 
								'data-type' => 'pixel',
							...
							'course-info-style' => array(
								'title' => __('Single Talk Info Style', 'gdlr-lms'),
								'type' => 'combobox',	
								'default' => 'style-1',
								'options' => array(
									'style-1' => __('Style 1', 'gdlr-lms'),
									'style-2' => __('Style 2', 'gdlr-lms'),
								)
							),
							'date-format' => array(
							...
							'transaction-record' => array(
								'title' => __('Transaction Record Per Page', 'gdlr-lms'),
								'type' => 'text',	
								'default' => 30
							),
							'show-header' => array(
								'title' => __('Display Page Title', 'gdlr-lms'),
								'type' => 'checkbox',	
								'default' => 'disable'
							),
							'show-sidebar' => array(
								'title' => __('Show Default Sidebar', 'gdlr-lms'),
								'type' => 'checkbox',	
								'default' => 'disable',
								'description' => __('To support twenty fourteen sidebar structure.', 'gdlr-lms')
							),	
							'jqueryui-style' => array(
								'title' => __('Include jQuery UI Style', 'gdlr-lms'),
								'type' => 'checkbox',	
								'default' => 'enable',
								'description' => __('Disable this if there\'re any conflicted with the theme or plugins.', 'gdlr-lms')
							),	
							'new-font-awesome' => array(
								'title' => __('Use New Font Awesome Version', 'gdlr-lms'),
								'type' => 'checkbox',	
								'default' => 'disable',
							),							
						)
					...
					'payment-option' => array(
						...
						'options' => array(
							...
							'payment-method' => array(
								...
								'type' => 'combobox',	
								'options' => array(
									'both' => __('Instant Payment and Receipt Confirmation', 'gdlr-lms'),
									'paypal' => __('Instant Payment', 'gdlr-lms'),
									'receipt' => __('Receipt Confirmation', 'gdlr-lms'),
								)
							),
							'instant-payment-method' => array(
								'title' => __('Instant Payment Method', 'gdlr-lms'),
								'type' => 'multi-combobox',	
								'options' => array(
									'paypal' =>  __('Paypal', 'gdlr-lms'),
									'stripe' =>  __('Stripe', 'gdlr-lms'),
									'paymill' =>  __('Paymill', 'gdlr-lms'),
									'authorize' =>  __('Authorize.Net', 'gdlr-lms'),
									'cloud' =>  __('Cloud Payment', 'gdlr-lms'),
									'braintree' =>  __('Braintree Payment', 'gdlr-lms'),
								),
								'description' => __('Leaving this field blank will display all available payment method.', 'gdlr-lms')
							),
						)
					),
					'paypal-payment-info' => array(
						'title' => __('Paypal Info', 'gdlr-lms'),
						'options' => array(	
					...
					'stripe-payment-info' => array(
						'title' => __('Stripe Info', 'gdlr-lms'),
						'options' => array(	
							'stripe-secret-key' => array(
								'title' => __('Stripe Secret Key', 'gdlr-lms'),
								'type' => 'text'
							),
							'stripe-publishable-key' => array(
								'title' => __('Stripe Publishable Key', 'gdlr-lms'),
								'type' => 'text'
							),	
							'stripe-currency-code' => array(
								'title' => __('Stripe Currency Code', 'gdlr-lms'),
								'type' => 'text',	
								'default' => 'usd'
							),	
						)
					...
					'paymill-payment-info' => array(
						'title' => __('Paymill Info', 'gdlr-lms'),
						'options' => array(	
							'paymill-private-key' => array(
								'title' => __('Paymill Private Key', 'gdlr-lms'),
								'type' => 'text'
							),
							'paymill-public-key' => array(
								'title' => __('Paymill Public Key', 'gdlr-lms'),
								'type' => 'text'
							),	
							'paymill-currency-code' => array(
								'title' => __('Paymill Currency Code', 'gdlr-lms'),
								'type' => 'text',	
								'default' => 'usd'
							),
						)
					...
					'authorize-payment-info' => array(
						'title' => __('Authorize Info', 'gdlr-lms'),
						'options' => array(	
							'authorize-live-mode' => array(
								'title' => __('Live Mode ', 'gdlr-lms'),
								'type' => 'checkbox',
								'default' => 'disable',
								'description' => __('Please turn this option off when you\'re on test mode.','gdlr-hotel')
							),
							'authorize-api-id' => array(
								'title' => __('Authorize API Login ID ', 'gdlr-lms'),
								'type' => 'text'
							),
							'authorize-transaction-key' => array(
								'title' => __('Authorize Transaction Key', 'gdlr-lms'),
								'type' => 'text'
							),
							'authorize-md5-hash' => array(
								'title' => __('Authorize MD5 Hash', 'gdlr-lms'),
								'type' => 'text'
							),
						)
					),
					'cloud-payment-info' => array(
						'title' => __('Cloud Payment Info', 'gdlr-lms'),
						'options' => array(	
							'cloud-public-id' => array(
								'title' => __('Public ID', 'gdlr-lms'),
								'type' => 'text',
								'default' => 'disable',
							),
							'cloud-currency-code' => array(
								'title' => __('Currency Code', 'gdlr-lms'),
								'type' => 'text',	
								'default' => 'USD'
							),
						)
					...
					'braintree-payment-info' => array(
						'title' => __('Braintree Payment Info', 'gdlr-lms'),
						'options' => array(	
							...
							'braintree-merchant-id' => array(
								'title' => __('Braintree Merchant ID ', 'gdlr-lms'),
								'type' => 'text'
							),
							'braintree-public-key' => array(
								'title' => __('Braintree Public Key', 'gdlr-lms'),
								'type' => 'text'
							),
							'braintree-private-key' => array(
								'title' => __('Braintree Private Key', 'gdlr-lms'),
								'type' => 'text'
							),
						)
					),					
					'course-style' => array(
						'title' => __('Talk Style', 'gdlr-lms'),
						'options' => array(						
							'archive-course-style' => array(
								'title' => __('Archive Talk Style', 'gdlr-lms'),
								'type' => 'combobox',	
								'options' => array(
							...
							'archive-course-size' => array(
								'title' => __('Archive Talk Size', 'gdlr-lms'),
								'type' => 'combobox',	
								'options'=> array(
									'4'=>'1/4',
									'3'=>'1/3',
							...
							'archive-course-thumbnail-size' => array(
								'title' => __('Archive Talk Thumbnail Size', 'gdlr-lms'),
								'type' => 'combobox',	
								'options' => gdlr_lms_get_thumbnail_list()
							),	
						)
					...
					'course-color' => array(
						...
						'options' => array(						
							...
							'course-grid2-bottom-border' => array(
								'title' => __('Talk Grid2 Bottom Border', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#95e0da',
							...
							'course-rating-star-color' => array(
								'title' => __('Talk Rating Star Color', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#f1c40f',
							...
							'course-rating-number-text' => array(
								'title' => __('Talk Rating Number', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#c5c5c5',
					...
					'course-content-color' => array(
						...
						'options' => array(	
							...
							'course-content-info-background' => array(
								'title' => __('Talk Content Info Background', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#f3f3f3',
							...
							'course-bullet-background-active' => array(
								'title' => __('Talk Bullet Background Active', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#72d5cd',
							...
							'course-bullet-inactive-title' => array(
								'title' => __('Talk Bullet Inactive Title', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#b9b9b9',
							...
							'course-bullet-title' => array(
								'title' => __('Talk Bullet Active Title', 'gdlr-lms'),
								'type' => 'colorpicker',
								'default' => '#5c5c5c',
