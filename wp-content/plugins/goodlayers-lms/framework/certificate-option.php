	...
	function gdlr_lms_create_certificate_meta_box(){
		...
		$certificate_settings = array(
			...
			'shortcode-description' => array(
				...
				'type' => 'description',
				'default' => 
'<br><span class="head">Wrapper - </span>[gdlr_cer_wrapper border="yes" background="XXX" class="XXX" student_code="true" ][/gdlr_cer_wrapper]' .
...
'<br><span class="head">Talk name - </span>[gdlr_cer_course_name font_size="25px" class="XXX"]' .
...
'<br><span class="head">Signature - </span>[gdlr_cer_signature image="XXX" font_size="15px" margin_top="0px" class="XXX"]Sam White, Talk Instructor[/gdlr_cer_signature]'
